...
This is the most secure way to integrate FedaPay. Your secret API keys are safely stored on your backend (e.g. using `ash-gate`), and the mobile app communicates via a secure proxy.
